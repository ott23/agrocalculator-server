...
public class TokenAuthenticationService {
    ...
    public static Authentication getAuthentication(HttpServletRequest request, UserDetailsService userDetailsService) {
        ...
        if (token != null) {
            String subjectString = Jwts.parser()
            ...
            try {
                ...
                String username = objectMapper.readTree(subjectString).get("username").textValue();
            ...
            return user != null ? new UsernamePasswordAuthenticationToken(user.getUsername(), null, user.getAuthorities()) : null;
        }
        return null;
    }
}